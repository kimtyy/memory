...
## 요약
현재 가장 가치 있는 단일 작업을 결정하고, 이를 실행할 적절한 에이전트를 배정하는 자율 사이클을 수행합니다.

## 분배
- **📱 영숙**: 회사 목표, 각 에이전트의 개인 목표 파일(goal.md), 최근 의사결정 기록 및 메모리를 검토하여 현재 가장 가치 있는 단일 작업 1개를 결정하고, 해당 작업을 실행할 적절한 에이전트 1~2명을 지정하여 실행 계획을 수립하라.
